...
| Package                   | Requirement       |
+===========================+===================+
| cone.charts               | cone.app >= 1.1   |
+---------------------------+-------------------+
| cone.three                | cone.app >= 1.1   |
+---------------------------+-------------------+
| cone.tokens               | cone.app >= 1.1   |
+---------------------------+-------------------+
| treibstoff                | cone.app >= 1.1   |
+---------------------------+-------------------+
| webresource               | cone.app >= 1.1   |
+---------------------------+-------------------+
| yafowil.widget.color      | yafowil >= 4.0    |
+---------------------------+-------------------+
| yafowil.widget.tiptap     | yafowil >= 4.0    |
+---------------------------+-------------------+
